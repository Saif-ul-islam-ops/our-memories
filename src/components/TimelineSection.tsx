      ...
      <div className="container max-w-3xl">
        ...
        {loading ? (
          ...
          <p className="text-center text-muted-foreground py-16">
            No milestones yet. Add your first moment!
          </p>
        ) : (
          <div className="relative">
            ...
            {events.map((ev, i) => (
              <div
                key={ev.id}
                className={`relative flex items-start mb-12 ${i % 2 === 0
                    ? "sm:flex-row"
                    : "sm:flex-row-reverse"
                  }`}
                style={{
                  animation: `reveal-up 0.6s cubic-bezier(0.16,1,0.3,1) ${i * 120
                    }ms forwards`,
                  opacity: 0,
                }}
              >
                ...
                {/* Card */}
                <div
                  className={`ml-14 sm:ml-0 sm:w-[45%] ${i % 2 === 0
                      ? "sm:pr-12"
                      : "sm:pl-12"
                    } group`}
                >
                  <div className="glass rounded-2xl p-6 hover:shadow-xl transition-all duration-500 relative">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-romantic-rose">
                        {ev.date}
                      </span>
                    </div>
          ...
          >
            ...
            <div className="space-y-4">
              <input
                ...
                placeholder="Title"
                className="w-full rounded-xl border border-border bg-background/60 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-romantic-rose/40"
              />
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-border bg-background/60 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-romantic-rose/40 resize-none"
              />
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              This special moment will be removed from your timeline.
            </p>
